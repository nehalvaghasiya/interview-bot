class Parameters:
    questions_prompt = "Job description: {job_description}\nBased on the given job description, kindly formulate two relevant interview questions. These questions should aim to assess the candidate's competency for the job role. Do not generate unnecessary texts except the questions. "
